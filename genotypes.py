...
base_resnet50 =  Genotype(normal=[('sep_conv_3x3', 2, 1), ('sep_conv_5x5', 2, 0), ('avg_pool_3x3', 3, 2), ('max_pool_3x3', 3, 0)], normal_concat=range(2, 4), reduce=[('dil_conv_5x5', 2, 1), ('sep_conv_5x5', 2, 0), ('dil_conv_3x3', 3, 1), ('dil_conv_3x3', 3, 2)], reduce_concat=range(2, 4))


studentarch_2step_v1 = Genotype(normal=[('sep_conv_3x3', 2, 1), ('sep_conv_5x5', 2, 0), ('sep_conv_5x5', 3, 1), ('dil_conv_5x5', 3, 2)], normal_concat = range(2, 4), 
reduce=[('sep_conv_5x5', 2, 1), ('max_pool_3x3', 2, 0), ('skip_connect', 3, 1), ('max_pool_3x3', 3, 0)], reduce_concat=range(2, 4))
studentarch_4step_v1 = Genotype(normal=[('sep_conv_3x3', 2, 0), ('sep_conv_3x3', 2, 1), ('max_pool_3x3', 3, 2), ('sep_conv_3x3', 3, 1), ('sep_conv_3x3', 4, 2), ('dil_conv_3x3', 4, 3), ('max_pool_3x3', 5, 2), ('max_pool_3x3', 5, 4)], normal_concat=range(2, 6), reduce=[], reduce_concat=range(2, 6))
arch_4step_nokd_v1 = Genotype(normal=[('sep_conv_5x5', 2, 1), ('dil_conv_3x3', 2, 0), ('sep_conv_3x3', 3, 0), ('sep_conv_5x5', 3, 2), ('dil_conv_3x3', 4, 3), ('sep_conv_3x3', 4, 2), ('skip_connect', 5, 2), ('dil_conv_5x5', 5, 0)], normal_concat=range(2, 6), reduce=[('sep_conv_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('sep_conv_5x5', 3, 1), ('dil_conv_3x3', 3, 2), ('dil_conv_5x5', 4, 1), ('dil_conv_5x5', 4, 2), ('dil_conv_5x5', 5, 1), ('dil_conv_3x3', 5, 2)], reduce_concat=range(2, 6))

base_2step_v1 = Genotype(normal=[('max_pool_3x3', 2, 0), ('dil_conv_3x3', 2, 1), ('max_pool_3x3', 3, 0), ('max_pool_3x3', 3, 1)], normal_concat=range(2, 4), reduce=[('sep_conv_5x5', 2, 0), ('dil_conv_5x5', 2, 1), ('dil_conv_3x3', 3, 1), ('dil_conv_3x3', 3, 2)], reduce_concat=range(2, 4))

resnet152_stu_2step = Genotype(normal=[('sep_conv_3x3', 2, 0)], normal_concat=range(2, 4), 
reduce=[('max_pool_3x3', 2, 0), ('dil_conv_3x3', 2, 1), ('sep_conv_3x3', 3, 0), ('avg_pool_3x3', 3, 2)], reduce_concat=range(2, 4))

vgg19_stu_2step = Genotype(normal=[('sep_conv_5x5', 2, 0), ('max_pool_3x3', 2, 1), ('sep_conv_3x3', 3, 0)], normal_concat=range(2, 4), 
reduce=[('max_pool_3x3', 2, 0), ('max_pool_3x3', 2, 1), ('sep_conv_3x3', 3, 0), ('sep_conv_3x3', 3, 1)], reduce_concat=range(2, 4))

densenet121_stu_2step = Genotype(normal=[('dil_conv_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('max_pool_3x3', 3, 0), ('sep_conv_3x3', 3, 1)], normal_concat=range(2, 4), 
reduce=[('sep_conv_5x5', 2, 1), ('sep_conv_5x5', 2, 0), ('sep_conv_3x3', 3, 1), ('sep_conv_3x3', 3, 0)], reduce_concat=range(2, 4))

densenet201_stu_2step = Genotype(normal=[('max_pool_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('max_pool_3x3', 3, 1), ('max_pool_3x3', 3, 2)], normal_concat=range(2, 4), 
reduce=[('sep_conv_5x5', 2, 0), ('sep_conv_5x5', 2, 1), ('skip_connect', 3, 1), ('dil_conv_5x5', 3, 0)], reduce_concat=range(2, 4))

resnet152_stu_2step_v2 =  Genotype(normal=[('sep_conv_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('sep_conv_3x3', 3, 0), ('sep_conv_3x3', 3, 2)], normal_concat=range(2, 4), reduce=[('sep_conv_5x5', 2, 1), ('dil_conv_3x3', 3, 1), ('max_pool_3x3', 3, 0)], reduce_concat=range(2, 4))



inceptionv3_stu_v1 = Genotype(normal=[('sep_conv_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('max_pool_3x3', 3, 2), ('max_pool_3x3', 3, 1)], normal_concat=range(2, 4), reduce=[('sep_conv_5x5', 3, 0), ('sep_conv_5x5', 3, 1)], reduce_concat=range(2, 4))

vgg16_cifar10_stu = Genotype(normal=[('max_pool_3x3', 2, 1), ('max_pool_3x3', 2, 0), ('sep_conv_3x3', 3, 1), ('max_pool_3x3', 3, 0)], normal_concat=range(2, 4), reduce=[('sep_conv_5x5', 2, 1), ('sep_conv_5x5', 2, 0), ('sep_conv_3x3', 3, 1), ('max_pool_3x3', 3, 0)], reduce_concat=range(2, 4))

# cifar100
resnet50_cifar100_2step = Genotype(normal=[('dil_conv_3x3', 2, 0), ('dil_conv_3x3', 2, 1), ('sep_conv_3x3', 3, 0), ('dil_conv_5x5', 3, 2)], normal_concat=range(2, 4), 
reduce=[('skip_connect', 2, 0), ('max_pool_3x3', 2, 1), ('skip_connect', 3, 1), ('sep_conv_5x5', 3, 0)], reduce_concat=range(2, 4))

resnet152_cifar100_2step = Genotype(normal=[('sep_conv_5x5', 2, 1), ('sep_conv_3x3', 2, 0), ('sep_conv_5x5', 3, 2), ('sep_conv_5x5', 3, 1)], normal_concat=range(2, 4), 
reduce=[('skip_connect', 2, 1), ('sep_conv_3x3', 2, 0), ('skip_connect', 3, 1), ('sep_conv_5x5', 3, 2)], reduce_concat=range(2, 4))


inceptionv3_cifar100_2step = Genotype(normal=[('max_pool_3x3', 2, 0), ('sep_conv_5x5', 2, 1), ('skip_connect', 3, 2), ('max_pool_3x3', 3, 1)], normal_concat=range(2, 4), 
reduce=[('dil_conv_5x5', 2, 1), ('sep_conv_5x5', 2, 0), ('sep_conv_3x3', 3, 2), ('skip_connect', 3, 1)], reduce_concat=range(2, 4))

vgg19_cifar100_2step = Genotype(normal=[('dil_conv_5x5', 2, 1), ('max_pool_3x3', 2, 0), ('sep_conv_3x3', 3, 0), ('dil_conv_5x5', 3, 1)], normal_concat=range(2, 4), 
reduce=[('dil_conv_5x5', 2, 1), ('sep_conv_3x3', 2, 0), ('dil_conv_5x5', 3, 0), ('max_pool_3x3', 3, 1)], reduce_concat=range(2, 4))

vgg16_cifar100_stu = Genotype(normal=[('sep_conv_3x3', 2, 0), ('sep_conv_5x5', 2, 1), ('sep_conv_5x5', 3, 2), ('sep_conv_5x5', 3, 1)], normal_concat=range(2, 4), reduce=[('dil_conv_5x5', 2, 1), ('skip_connect', 2, 0), ('skip_connect', 3, 1), ('sep_conv_3x3', 3, 0)], reduce_concat=range(2, 4))

densenet201_cifar100_stu =  Genotype(normal=[('sep_conv_5x5', 2, 1), ('sep_conv_5x5', 2, 0), ('dil_conv_5x5', 3, 2), ('sep_conv_5x5', 3, 1)], normal_concat=range(2, 4), reduce=[('sep_conv_3x3', 2, 0), ('sep_conv_5x5', 3, 0), ('skip_connect', 3, 2)], reduce_concat=range(2, 4))


# vegetable
resnet50_vege_stu  = Genotype(normal=[('dil_conv_3x3', 2, 1), ('sep_conv_3x3', 2, 0), ('skip_connect', 3, 1), ('dil_conv_5x5', 3, 0)], normal_concat=range(2, 4), reduce=[('dil_conv_3x3', 2, 1), ('sep_conv_3x3', 2, 0), ('sep_conv_3x3', 3, 2), ('skip_connect', 3, 1)], reduce_concat=range(2, 4))
densenet201_vege_stu = Genotype(normal=[('max_pool_3x3', 2, 1), ('dil_conv_3x3', 2, 0), ('dil_conv_3x3', 3, 2), ('sep_conv_5x5', 3, 0)], normal_concat=range(2, 4), reduce=[('sep_conv_5x5', 2, 0), ('sep_conv_3x3', 3, 1)], reduce_concat=range(2, 4))

resnet152_vege_stu =  Genotype(normal=[('sep_conv_3x3', 2, 1), ('sep_conv_5x5', 3, 1), ('sep_conv_5x5', 3, 0)], normal_concat=range(2, 4), reduce=[('dil_conv_5x5', 2, 0), ('dil_conv_3x3', 2, 1), ('skip_connect', 3, 0), ('dil_conv_5x5', 3, 2)], reduce_concat=range(2, 4))
